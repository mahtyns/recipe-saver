...
const LabelList = (props: LabelListProps) => {
    ...
    const renderLabels = (label: LabelData) => <Label mainClass={props.mainClass} label={label.label} />
    return (
        <div>
            ...
            <div className={`${props.mainClass}__add`}>
                ...
                <div className={`${props.mainClass}__add__wrapper`}>
                    <form onSubmit={(e) => {
                        ...
                        <Button variant="primary" text={labelsPageContent.input.button} handleClick={() => handleSubmit()} />
                    </form>
                </div>
            </div>
        </div>
